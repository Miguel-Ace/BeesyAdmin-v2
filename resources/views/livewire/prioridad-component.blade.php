<div class="flex-1 bg-slate-700">
    ...
    <div class="text-white p-2 flex justify-between">
        <p class="text-[1.5rem]">Prioridades</p>
            ...
            <div class="bg-white w-[40%] flex flex-col">
                ...
                <div class="p-3 flex flex-col gap-2">
                    <div class="flex items-center">
                        <label for="nombre" class="font-semibold w-[10rem] @error('nombre') text-red-800 @enderror">Nombre</label>
                        <div class="w-full">
